...
<head>
    ...
    <title>افزودن خواننده جدید | پنل مدیریت</title>
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            <div class="flex items-center mb-6">
                ...
                <h1 class="text-3xl font-bold text-gray-900">افزودن خواننده جدید</h1>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <form action="{{ route('admin.artists.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="bio" id="bio" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('bio') }}</textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_featured" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" {{ old('is_featured') ? 'checked' : '' }}>
